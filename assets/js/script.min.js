 ...
 */
function(t){"function"==typeof define&&define.amd?define(["jquery"],t):"object"==typeof exports?t(require("jquery")):t(jQuery)}((function(t){var e=/\+/g;function i(t){return o.raw?t:encodeURIComponent(t)}function n(t){return i(o.json?JSON.stringify(t):String(t))}function s(i,n){var s=o.raw?i:function(t){0===t.indexOf('"')&&(t=t.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{return t=decodeURIComponent(t.replace(e," ")),o.json?JSON.parse(t):t}catch(t){}}(i);return t.isFunction(n)?n(s):s}var o=t.cookie=function(e,r,a){if(void 0!==r&&!t.isFunction(r)){if("number"==typeof(a=t.extend({},o.defaults,a)).expires){var l=a.expires,h=a.expires=new Date;h.setTime(+h+864e5*l)}return document.cookie=[i(e),"=",n(r),a.expires?"; expires="+a.expires.toUTCString():"",a.path?"; path="+a.path:"",a.domain?"; domain="+a.domain:"",a.secure?"; secure":""].join("")}for(var c,d=e?void 0:{},u=document.cookie?document.cookie.split("; "):[],f=0,p=u.length;f<p;f++){var g=u[f].split("="),m=(c=g.shift(),o.raw?c:decodeURIComponent(c)),v=g.join("=");if(e&&e===m){d=s(v,r);break}e||void 0===(v=s(v))||(d[m]=v)}return d};o.defaults={},t.removeCookie=function(e,i){return void 0!==t.cookie(e)&&(t.cookie(e,"",t.extend({},i,{expires:-1})),!t.cookie(e))}})),$(window).on("load",(function(){jQuery("img.svg").each((function(){var t=jQuery(this),e=t.attr("id"),i=t.attr("class"),n=t.attr("src");jQuery.get(n,(function(n){var s=jQuery(n).find("svg");void 0!==e&&(s=s.attr("id",e)),void 0!==i&&(s=s.attr("class",i+" replaced-svg")),!(s=s.removeAttr("xmlns:a")).attr("viewBox")&&s.attr("height")&&s.attr("width")&&s.attr("viewBox","0 0 "+s.attr("height")+" "+s.attr("width")),t.replaceWith(s)}),"xml")}))})),$(window).on("load",(function(){$(".flickity__slider").flickity({cellAlign:"left",contain:!0,freeScroll:!1,wrapAround:!0,pageDots:!1})})),$(window).on("load",(function(){$.cookie("font_size")?$("html").addClass($.cookie("font_size")):($("html").addClass("font-medium"),$.cookie("font_size","font-medium",{expires:365,path:"/"})),$("#section--page--header--main .font__smaller").on("click",(function(){$("html").removeClass("font-medium").removeClass("font-large"),"font-medium"==$.cookie("font_size")?($.cookie("font_size","font-small",{expires:365,path:"/"}),$("html").addClass("font-small")):"font-large"==$.cookie("font_size")&&($.cookie("font_size","font-medium",{expires:365,path:"/"}),$("html").addClass("font-medium"))})),$("#section--page--header--main .font__larger").on("click",(function(){$("html").removeClass("font-small").removeClass("font-medium"),"font-small"==$.cookie("font_size")?($.cookie("font_size","font-medium",{expires:365,path:"/"}),$("html").addClass("font-medium")):"font-medium"==$.cookie("font_size")&&($.cookie("font_size","font-large",{expires:365,path:"/"}),$("html").addClass("font-large"))}))})),$(window).on("load",(function(){"true"!=$.cookie("accept_cookies")&&$("#welcome__modal").modal("show",{backdrop:"static",keyboard:!1}),$("#welcome__modal .modal__accept").on("click",(function(){$("#welcome__modal").modal("hide"),$.cookie("accept_cookies","true",{expires:365,path:"/"})})),$("#welcome__modal .modal__decline").on("click",(function(){$("#welcome__modal").modal("hide"),window.history.back()}))}));